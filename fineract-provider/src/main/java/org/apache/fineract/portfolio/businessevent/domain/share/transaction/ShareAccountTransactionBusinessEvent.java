...
public abstract  class ShareAccountTransactionBusinessEvent extends AbstractBusinessEvent<ShareAccountTransaction> {
    public ShareAccountTransactionBusinessEvent(ShareAccountTransaction value){super(value);}
}
